  ...
  render(){
    ...
    return (<Page id="homepage">
      {users && users.map(user => <div key={user.id}>
        <img src={user.avatar} width='100' height='100' alt={user.first_name} />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(frontloadConnect(frontload, {onMount:true, onUpdate:false})(Home)));
